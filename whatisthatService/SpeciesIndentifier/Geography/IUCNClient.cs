...
using whatisthatService.SpeciesIndentifier.Geography.Dto;
using whatisthatService.SpeciesIndentifier.Utilities.Caching;
using Geometry = NetTopologySuite.Geometries.Geometry;

namespace whatisthatService.SpeciesIndentifier.Geography
{
    public class IUCNClient
    {
        ...
        private static readonly DirectoryInfo GeographicSpeciesListCacheDirectoryInfo = new DirectoryInfo(GeographyDirectoryInfo.FullName + "/Cache/");
        private static readonly GenericLongTermCache<GeographicSpeciesListDto> GeographicSpeciesListDataCache = new GenericLongTermCache<GeographicSpeciesListDto>(GeographicSpeciesListCacheDirectoryInfo);
